...
import it.unibo.jakta.agents.bdi.engine.Jakta.parseClause
...
import it.unibo.jakta.agents.bdi.engine.visitors.SourceAnonymizerVisitor
...
internal class BeliefBaseImpl private constructor(
    ...
    override fun solve(
        belief: Belief,
        ignoreSource: Boolean,
    ): Solution = solve(belief.rule.head)

    override fun solveAll(
        belief: Belief,
        ignoreSource: Boolean,
    ): Sequence<Solution> = solveAll(belief.rule.head)
