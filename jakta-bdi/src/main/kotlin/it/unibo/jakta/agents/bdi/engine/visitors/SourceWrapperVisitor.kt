package it.unibo.jakta.agents.bdi.engine.visitors
...
class SourceWrapperVisitor(
    private val source: Term = Belief.SOURCE_SELF,
    ...
    companion object {
        ...
        fun wrapSelectively(
            term: Term,
            source: Term = Belief.SOURCE_SELF,
        ): Term = term.accept(SourceWrapperVisitor(source))
    }
}
