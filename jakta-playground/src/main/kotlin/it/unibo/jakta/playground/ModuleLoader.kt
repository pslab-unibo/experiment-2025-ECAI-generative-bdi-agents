...
import it.unibo.jakta.agents.bdi.narrativegenerator.serialization.NarrativeGenerationJsonModule
...
object ModuleLoader {
    val jsonModule =
        module {
            ...
            single<SerializersModuleProvider>(named("NarrativeGenerationJsonModule")) {
                NarrativeGenerationJsonModule()
            }
        }
